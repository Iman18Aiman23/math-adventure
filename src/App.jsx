...
const KombinasiNombor = React.lazy(() => import('./components/MatematikPage/Tahun1/Module1_NomborHingga100/KombinasiNombor'));
const Kenali21Hingga100 = React.lazy(() => import('./components/MatematikPage/Tahun1/Module1_NomborHingga100/Kenali21Hingga100'));
const NilaiTempatDigit = React.lazy(() => import('./components/MatematikPage/Tahun1/Module1_NomborHingga100/NilaiTempatDigit'));
const SusunanNombor = React.lazy(() => import('./components/MatematikPage/Tahun1/Module1_NomborHingga100/SusunanNombor'));
const PolaNombor = React.lazy(() => import('./components/MatematikPage/Tahun1/Module1_NomborHingga100/PolaNombor'));
const AnggarBundar = React.lazy(() => import('./components/MatematikPage/Tahun1/Module1_NomborHingga100/AnggarBundar'));
const Selesaikan = React.lazy(() => import('./components/MatematikPage/Tahun1/Module1_NomborHingga100/Selesaikan'));
...
const TambahBerulang = React.lazy(() => import('./components/MatematikPage/Tahun1/Module2_TambahDanTolak/TambahBerulang'));
...
const SelesaikanWaktu  = React.lazy(() => import('./components/MatematikPage/Tahun1/Module5_MasaDanWaktu/SelesaikanWaktu'));
const SelesaikanBulan  = React.lazy(() => import('./components/MatematikPage/Tahun1/Module5_MasaDanWaktu/SelesaikanBulan'));
...
const UkuranModule = React.lazy(() => import('./components/MatematikPage/Tahun1/Module6_Ukuran/UkuranModule'));
...
export default function App() {
  ...
  const renderContent = () => {
    ...
    switch (currentSubject) {
      ...
      case 'matematik-kssr':
        ...
        if (matematikTopic === 'kombinasi-nombor')    return <KombinasiNombor        onBack={() => setMatematikTopic(null)} language={language} />;
        if (matematikTopic === 'kenali-21-100')      return <Kenali21Hingga100       onBack={() => setMatematikTopic(null)} language={language} />;
        if (matematikTopic === 'nilai-tempat')       return <NilaiTempatDigit        onBack={() => setMatematikTopic(null)} language={language} />;
        if (matematikTopic === 'susunan-nombor')    return <SusunanNombor           onBack={() => setMatematikTopic(null)} language={language} />;
        if (matematikTopic === 'pola-nombor')       return <PolaNombor              onBack={() => setMatematikTopic(null)} language={language} />;
        if (matematikTopic === 'anggar-bundar')     return <AnggarBundar            onBack={() => setMatematikTopic(null)} language={language} />;
        ...
        if (matematikTopic === 'selesaikan-waktu')   return <SelesaikanWaktu    onBack={() => setMatematikTopic(null)} language={language} />;
        if (matematikTopic === 'selesaikan-bulan')   return <SelesaikanBulan    onBack={() => setMatematikTopic(null)} language={language} />;
        ...
        if (matematikModule) {
          ...
          if (matematikYear === 1) {
            ...
            if (mod === 'ukuran')            hubComponent = <UkuranModule />;
          } else {
  ...
  const MT_ORDERS = [MT_MODULE1_ORDER, MT_MODULE2_ORDER, MT_MODULE3_ORDER, MT_MODULE4_ORDER, MT_MODULE5_ORDER, MT_MODULE6_ORDER];
