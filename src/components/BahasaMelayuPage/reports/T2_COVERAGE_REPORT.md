...
- **(2026-06-14) M1 — PECAH 2 → 5 topik** (selaras falsafah pecah M5: node fokus, murid boleh berhenti ikut level + setiap topik penuhi minima ≥12 item). Slicing **ikut kemahiran**:
  - **1.1** (Mendengar, Memahami & Merespons) → **1.1a** Merespons Soalan (bertumpu+bercapah, STT) · **1.1b** Melaksanakan Arahan (arahan berbilang langkah → buat → lapor-diri) · **1.1c** Pesanan & Permintaan (sampaikan/minta → lapor-diri).
