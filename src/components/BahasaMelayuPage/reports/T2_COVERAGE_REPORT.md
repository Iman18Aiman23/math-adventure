...
| R13 / 1.2 — Bercerita (baca kuat) & Berbincang | `BUILD_SPEC_R13_1.2.md` | ✅ Completed (verify+fix) | 2026-06-14 |
| R12 / 1.1 — Soalan (bertumpu+bercapah) + Arahan/Pesanan/Permintaan | `BUILD_SPEC_R12_1.1.md` | ⏳ Pending (build sederhana — STT 2-tier) | — |
