...
| **M1 split (2→5 topik) — Keputusan 2026-06-14** | — | **⏳ 0/5** | — |
...
| · 1.2a — Bercerita (baca kuat) | `BUILD_SPEC_M1_1.2a_1.2b.md` | 🔍 Pending verification | — |
| · 1.2b — Berbincang | `BUILD_SPEC_M1_1.2a_1.2b.md` | 🔍 Pending verification | — |
