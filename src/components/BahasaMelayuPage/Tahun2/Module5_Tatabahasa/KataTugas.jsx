...
const TOPIC_ID = '2-5-1c-kata-tugas';
const ACCENT = '#159E96';

// Four categories shown as expandable learn cards before the quiz.
const CATEGORIES = [
  {
    title: 'Kata Seru',
...
function KataTugasLearnPage({ onBack, onStartQuiz, topicTitle, language }) {
      ...
      <div className="kba-learn-root">
        ...
        <div className="kba-body">
          <div className="kba-heading">
            <h1>{language === 'bm' ? 'Kata Tugas 💬' : 'Function Words 💬'}</h1>
...
export default function KataTugas({ onBack, language = 'bm', topicComplete, onNextTopic }) {
  ...
  const topicTitle = language === 'bm' ? 'Kata Tugas' : 'Function Words';
