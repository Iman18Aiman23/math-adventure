...
const TOPIC_ID = '2-1-2b-berbincang';
const ACCENT = '#E8821A';

const CATEGORIES = [
  {
    title: 'Beri Pendapat yang Baik',
    desc: 'Fikir dahulu, kemudian beri jawapan yang sopan dan menolong.',
  ...
  {
    title: 'Nilai Murni',
    desc: 'Jawapan yang baik menunjukkan nilai seperti tolong-menolong, hormat, dan jujur.',
...
function BerbincangLearnPage({ onBack, onStartQuiz, topicTitle, language }) {
      ...
      <div className="kba-learn-root">
        ...
        <div className="kba-body">
          <div className="kba-heading">
            <h1>{language === 'bm' ? 'Berbincang 💬' : 'Discuss 💬'}</h1>
            <p>{language === 'bm' ? 'Ketuk untuk belajar cara berbincang' : 'Tap to learn discussion skills'}</p>
          </div>
...
export default function Berbincang({ onBack, language = 'bm', topicComplete, onNextTopic }) {
