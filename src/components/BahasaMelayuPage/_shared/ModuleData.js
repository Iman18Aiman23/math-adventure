import {
  ...
  M1Vokal, M1KonsonanBJ, M1KonsonanKR, M1KonsonanSZ,
   M1SukuKata, M1DengarTeka, M1DengarBuat, M1KenalkanDiri, M1FrasaBergambar,
  M2Topic1, M2Topic2, M2Topic3, M2Topic4, M2Topic5,
  M3Topic1, M3Topic2, M3Topic3,
  M3Vokal, M3KonsonanBJ, M3KonsonanKR, M3KonsonanSZ,
   M4Topic1, M4Topic2, M4Topic3,
   M5Topic1, M5Topic2, M5Topic3, M5Topic4, M5Topic5,
} from './BMJourneySvgs';
...
const T1_MODULES = [
  buildModule(1,
    ...
    M1Badge, M1_THEME, 1, [
      ...
      { id: '1-1-9-kenalkan-diri',        num: '1.9', label: 'Kenalkan Diri',                       icon: M1KenalkanDiri, disabled: false },
    ]),
  buildModule(2,
    'Kemahiran Membaca',
    'Reading Skills',
  ...
  buildModule(3,
    ...
    'Writing Skills',
    M3Badge, M3_THEME, 1, [
      { id: '1-3-1-menulis-vokal',         num: '3.1', label: 'Menulis Huruf Vokal',               icon: M3Vokal, disabled: false },
      { id: '1-3-2-menulis-konsonan-bj',   num: '3.2', label: 'Konsonan B–J',                      icon: M3KonsonanBJ, disabled: false },
      { id: '1-3-3-menulis-konsonan-kr',   num: '3.3', label: 'Konsonan K–R',                      icon: M3KonsonanKR, disabled: false },
      { id: '1-3-4-menulis-konsonan-sz',   num: '3.4', label: 'Konsonan S–Z',                      icon: M3KonsonanSZ, disabled: false },
      { id: '1-3-5-bina-ayat',             num: '3.5', label: 'Menulis & Membina Ayat',             icon: M3Topic2, disabled: false },
      { id: '1-3-6-mencatat-maklumat',     num: '3.6', label: 'Mencatat Maklumat',                  icon: M3Topic3, disabled: false },
    ]),
  buildModule(4,
    'Aspek Seni Bahasa',
    'Language Arts',
    M4Badge, M4_THEME, 1, [
      { id: '1-4-1-dialog',               num: '4.1', label: 'Dialog',                              icon: M4Topic1, disabled: false },
      { id: '1-4-2-pantun',               num: '4.2', label: 'Pantun',                              icon: M4Topic2, disabled: false },
      { id: '1-4-3-lagu',                 num: '4.3', label: 'Lagu',                                icon: M4Topic3, disabled: false },
    ]),
  buildModule(5,
    'Aspek Tatabahasa',
    'Grammar',
    M5Badge, M5_THEME, 1, [
      { id: '1-5-1-morfologi-kata',       num: '5.1', label: 'Kata Nama Am & Khas',               icon: M5Topic1, disabled: false },
      { id: '1-5-6-kerja-adjektif',       num: '5.2', label: 'Kata Kerja & Adjektif',             icon: M5Topic4, disabled: false },
      { id: '1-5-7-hubung-sendi',         num: '5.3', label: 'Kata Hubung & Sendi Nama',          icon: M5Topic5, disabled: false },
      { id: '1-5-8-tanya-ganti',          num: '5.4', label: 'Kata Tanya & Ganti Nama',           icon: M5Topic2, disabled: false },
      { id: '1-5-2-sintaksis-ayat',       num: '5.5', label: 'Ayat Tunggal',                       icon: M5Topic3, disabled: false },
    ]),
];
...
const T2_MODULES = [
  buildModule(1,
    ...
    M1Badge, M1_THEME, 2, [
      // Tahun 2 nodes all render the shared BMUnifiedRobotM2 guardian head in the
      // hub, so topics carry no per-topic `icon` (it would never be rendered).
      { id: '2-1-1a-merespons-soalan',     num: '1.1a', label: 'Merespons Soalan',      disabled: false },
      { id: '2-1-1b-mendengar-arahan',      num: '1.1b', label: 'Mendengar Arahan',       disabled: false },
      { id: '2-1-1c-ikut-susunan',          num: '1.1c', label: 'Ikut Susunan',            disabled: false },
      { id: '2-1-1d-pesanan',               num: '1.1d', label: 'Pesanan',                 disabled: false },
      { id: '2-1-1e-permintaan',           num: '1.1e', label: 'Permintaan',              disabled: false },
      { id: '2-1-2a-bercerita',  num: '1.2a', label: 'Bercerita (Baca Kuat)', disabled: false },
      { id: '2-1-2b-beri-pendapat-baik', num: '1.2b', label: 'Beri Pendapat Baik',            disabled: false },
      { id: '2-1-2c-nilai-murni',        num: '1.2c', label: 'Nilai Murni',                  disabled: false },
    ]),
  buildModule(2,
    'Kemahiran Membaca',
    'Reading Skills',
    M2Badge, M2_THEME, 2, [
      { id: '2-2-1-perkataan-sukar',      num: '2.1', label: 'Perkataan Sukar (Digraf & Diftong)',  disabled: false },
      { id: '2-2-2-teks-pelbagai',        num: '2.2', label: 'Membaca Teks Pelbagai Gaya',          disabled: false },
      { id: '2-2-3-mentafsir-menaakul',   num: '2.3', label: 'Membaca, Mentafsir & Menaakul',       disabled: false },
    ]),
  buildModule(3,
    'Kemahiran Menulis',
    'Writing Skills',
    M3Badge, M3_THEME, 2, [
      { id: '2-3-1-menulis-mekanis',      num: '3.1', label: 'Menulis secara Mekanis',              disabled: false },
      { id: '2-3-2-hasilkan-penulisan',   num: '3.2', label: 'Membina & Menghasilkan Penulisan',    disabled: false },
      { id: '2-3-3-jawapan-pemahaman',    num: '3.3', label: 'Menulis Jawapan Pemahaman',           disabled: false },
    ]),
  buildModule(4,
    'Aspek Seni Bahasa',
    'Language Arts',
    M4Badge, M4_THEME, 2, [
      { id: '2-4-1-apresiasi-sastera',    num: '4.1', label: 'Apresiasi Sastera Kanak-kanak',      disabled: false },
      { id: '2-4-2-persembahan-karya',    num: '4.2', label: 'Persembahan Karya',                  disabled: false },
    ]),
  buildModule(5,
    'Aspek Tatabahasa',
    'Grammar',
    M5Badge, M5_THEME, 2, [
      { id: '2-5-1a-kata-bilangan-arah',   num: '5.1a', label: 'Kata Bilangan & Kata Arah',          disabled: false },
      { id: '2-5-1b-kerja-pasif-adjektif', num: '5.1b', label: 'Kata Kerja Pasif & Kata Adjektif',   disabled: false },
      { id: '2-5-1c-kata-tugas',           num: '5.1c', label: 'Kata Tugas',                          disabled: false },
      { id: '2-5-2-pembentukan-perkataan', num: '5.2', label: 'Pembentukan Perkataan',              disabled: false },
      { id: '2-5-3-sintaksis-ayat-majmuk', num: '5.3', label: 'Sintaksis (Ayat Majmuk)',            disabled: false },
    ]),
];
...
export const BM_QUESTIONS = {
  ...
  '1-1-1-mendengar-menyebut': [
    ...
    { question: 'Apakah ini?', emoji: '🔧', answer: 'Alat', options: ['Alat', 'Udang', 'Istana', 'Otak'] },
    // ── E ──
    { question: 'Apakah ini?', emoji: '🍎', answer: 'Epal', options: ['Epal', 'Oren', 'Api', 'Ikan'] },
    ...
    { question: 'Apakah ini?', emoji: '🏰', answer: 'Istana', options: ['Istana', 'Orang', 'Awan', 'Api'] },
    // ── O ──
    { question: 'Apakah ini?', emoji: '🍊', answer: 'Oren', options: ['Oren', 'Epal', 'Api', 'Ikan'] },
    ...
    { question: 'Apakah ini?', emoji: '🐫', answer: 'Unta', options: ['Unta', 'Itik', 'Enam', 'Api'] },
  ],
  ...
  '1-1-5-konsonan-sz': [
    ...
    { question: 'Apakah ini?', emoji: '🐌', answer: 'Siput', options: ['Siput', 'Susu', 'Zirafah', 'Wau'] },
    { question: 'Apakah ini?', emoji: '🧼', answer: 'Sabun', options: ['Sabun', 'Siput', 'Telefon', 'Yoyo'] },
    ...
    { question: 'Apakah ini?', emoji: '🚐', answer: 'Van', options: ['Van', 'Wau', 'Tomato', 'Siput'] },
    ...
    { question: 'Apakah ini?', emoji: '🦒', answer: 'Zirafah', options: ['Zirafah', 'Zebra', 'Siput', 'Wau'] },
  ...
  '1-1-6-dengar-teka': [
    ...
    { question: 'Perkataan mana yang kamu dengar?', audioText: 'zirafah', answer: 'Zirafah', options: ['Zirafah', 'Zebra', 'Siput', 'Gajah'] },
  ],
  ...
  '1-3-6-mencatat-maklumat': [
    { passageIndex: 0, emoji: '📝', question: 'Siapakah nama budak dalam petikan "Keluarga Saya"?', answer: 'Ali', options: ['Ali', 'Abu', 'Amin', 'Ahmad'] },
    { passageIndex: 0, emoji: '📝', question: 'Berapa umur Ali?', answer: '7 tahun', options: ['7 tahun', '6 tahun', '8 tahun', '5 tahun'] },
    { passageIndex: 0, emoji: '📝', question: 'Di mana Ali tinggal?', answer: 'Kuala Lumpur', options: ['Kuala Lumpur', 'Johor Bahru', 'Pulau Pinang', 'Melaka'] },
    { passageIndex: 0, emoji: '📝', question: 'Apakah hobi Ali?', answer: 'Membaca buku', options: ['Membaca buku', 'Melukis', 'Bermain bola', 'Menulis'] },
    { passageIndex: 0, emoji: '📝', question: 'Berapa orang adik-beradik Ali?', answer: 'Dua', options: ['Dua', 'Tiga', 'Seorang', 'Empat'] },
    { passageIndex: 1, emoji: '📝', question: 'Siapakah nama kucing Cikgu Siti?', answer: 'Comel', options: ['Comel', 'Manja', 'Gemuk', 'Cantik'] },
    { passageIndex: 1, emoji: '📝', question: 'Apakah warna kucing Cikgu Siti?', answer: 'Putih dan kelabu', options: ['Putih dan kelabu', 'Hitam dan putih', 'Oren dan putih', 'Kelabu sahaja'] },
    { passageIndex: 1, emoji: '📝', question: 'Apa makanan kegemaran Comel?', answer: 'Ikan', options: ['Ikan', 'Susu', 'Daging', 'Nasi'] },
    { passageIndex: 2, emoji: '📝', question: 'Pada hari apakah lawatan ke Zoo Negara?', answer: 'Sabtu', options: ['Sabtu', 'Ahad', 'Isnin', 'Jumaat'] },
    { passageIndex: 2, emoji: '📝', question: 'Murid Tahun 1 pergi ke zoo naik apa?', answer: 'Bas', options: ['Bas', 'Kereta', 'Van', 'Motorsikal'] },
    { passageIndex: 2, emoji: '📝', question: 'Haiwan apakah yang TIDAK disebut dalam lawatan ke zoo?', answer: 'Zirafah', options: ['Zirafah', 'Gajah', 'Harimau', 'Monyet'] },
    { passageIndex: 2, emoji: '📝', question: 'Di manakah mereka makan tengah hari?', answer: 'Di kantin zoo', options: ['Di kantin zoo', 'Di rumah', 'Di dalam bas', 'Di padang'] },
    { passageIndex: 3, emoji: '📝', question: 'Apakah nama taman permainan dalam petikan?', answer: 'Taman Permainan Aman Bestari', options: ['Taman Permainan Aman Bestari', 'Taman Permainan Indah', 'Taman Permainan Murni', 'Taman Permainan Bahagia'] },
    { passageIndex: 3, emoji: '📝', question: 'Apakah yang ditanam di tepi taman?', answer: 'Pokok bunga', options: ['Pokok bunga', 'Pokok buah', 'Sayur-sayuran', 'Rumput'] },
    { passageIndex: 3, emoji: '📝', question: 'Bilakah kanak-kanak bermain di taman?', answer: 'Setiap petang', options: ['Setiap petang', 'Setiap pagi', 'Setiap malam', 'Setiap tengah hari'] },
  ],
  // ── T1 M4 T4.1: Dialog ───────────────────────────────────────
  // Speaking practice via roleplay — no quiz.
  '1-4-1-dialog': [],
  // ── T1 M4 T4.2: Pantun ───────────────────────────────────────
  // Per-pantun comprehension questions — filtered by pantunIndex.
  '1-4-2-pantun': [
    // Pantun 1: Banyak udang banyak garam
    { pantunIndex: 0, question: 'Apakah maksud pantun "Banyak udang banyak garam, banyak orang banyak ragam"?', answer: 'Setiap orang mempunyai sikap yang berbeza', options: ['Setiap orang mempunyai sikap yang berbeza', 'Semua orang sama sikapnya', 'Udang lebih penting daripada garam', 'Garam lebih mahal daripada udang'] },
    { pantunIndex: 0, question: 'Apakah tema pantun "Banyak udang banyak garam"?', answer: 'Kepelbagaian sikap manusia', options: ['Kepelbagaian sikap manusia', 'Kesenangan hidup', 'Kerajinan', 'Pendidikan'] },
    { pantunIndex: 0, question: 'Pantun "Banyak udang banyak garam" termasuk dalam jenis...?', answer: 'Pantun Dua Kerat', options: ['Pantun Dua Kerat', 'Pantun Empat Kerat', 'Pantun Enam Kerat', 'Pantun Lapan Kerat'] },
    // Pantun 2: Gendang gendut tali kecapi
    { pantunIndex: 1, question: 'Apakah perasaan dalam pantun "Gendang gendut tali kecapi, kenyang perut suka hati"?', answer: 'Gembira selepas makan', options: ['Gembira selepas makan', 'Sedih kerana lapar', 'Marah kerana penat', 'Takut kerana gelap'] },
    { pantunIndex: 1, question: 'Apakah tema pantun "Gendang gendut tali kecapi"?', answer: 'Kesenangan', options: ['Kesenangan', 'Kepelbagaian', 'Kerajinan', 'Pendidikan'] },
    { pantunIndex: 1, question: 'Apakah pengajaran pantun "Gendang gendut tali kecapi"?', answer: 'Kenyang perut membawa kegembiraan', options: ['Kenyang perut membawa kegembiraan', 'Jangan makan terlalu banyak', 'Bersenang-senang setiap hari', 'Tali kecapi alat muzik'] },
    // Pantun 3: Emas, perak, tembaga, suasa
    { pantunIndex: 2, question: 'Apakah pengajaran pantun "Emas, perak, tembaga, suasa, malas bergerak tidak merasa"?', answer: 'Rajin berusaha untuk mendapat hasil', options: ['Rajin berusaha untuk mendapat hasil', 'Bermain sepanjang hari', 'Tidur lebih lama', 'Malas ke sekolah'] },
    { pantunIndex: 2, question: 'Apakah tema pantun "Emas, perak, tembaga, suasa"?', answer: 'Kerajinan', options: ['Kerajinan', 'Kesenangan', 'Kepelbagaian', 'Budi bahasa'] },
    { pantunIndex: 2, question: '"Malas bergerak tidak merasa" bermaksud...?', answer: 'Orang malas tidak mendapat apa-apa', options: ['Orang malas tidak mendapat apa-apa', 'Orang malas tidak berasa sakit', 'Orang malas tidak lapar', 'Orang malas tidur lena'] },
    // Pantun 4: Pergi ke kedai membeli gula
    { pantunIndex: 3, question: 'Apakah nasihat dalam pantun "Pergi ke kedai membeli gula"?', answer: 'Rajin belajar supaya pandai dan berbakti', options: ['Rajin belajar supaya pandai dan berbakti', 'Jangan lupa beli gula', 'Pergi ke kedai setiap hari', 'Beli roti sebuku'] },
    { pantunIndex: 3, question: 'Apakah tema pantun "Pergi ke kedai membeli gula"?', answer: 'Pendidikan', options: ['Pendidikan', 'Kesenangan', 'Kerajinan', 'Budi bahasa'] },
    { pantunIndex: 3, question: '"Belajar rajin di sekolah" — baris ini ialah...?', answer: 'Maksud pantun', options: ['Maksud pantun', 'Pembayang pantun', 'Isi pantun', 'Tema pantun'] },
    { pantunIndex: 3, question: 'Pantun "Pergi ke kedai membeli gula" termasuk dalam jenis...?', answer: 'Pantun Empat Kerat', options: ['Pantun Empat Kerat', 'Pantun Dua Kerat', 'Pantun Enam Kerat', 'Pantun Lapan Kerat'] },
    // Pantun 5: Tingkap papan kayu bersegi
    { pantunIndex: 4, question: 'Apakah pengajaran pantun "Tingkap papan kayu bersegi"?', answer: 'Jaga budi bahasa dan pertuturan', options: ['Jaga budi bahasa dan pertuturan', 'Tingkap perlu dicat', 'Kayu bersegi itu cantik', 'Sampan sakat di Pulau Angsa'] },
    { pantunIndex: 4, question: 'Apakah tema pantun "Tingkap papan kayu bersegi"?', answer: 'Budi bahasa', options: ['Budi bahasa', 'Pendidikan', 'Kerajinan', 'Kesenangan'] },
    { pantunIndex: 4, question: '"Indah tampan kerana budi" bermaksud...?', answer: 'Seseorang dihargai kerana budi pekerti', options: ['Seseorang dihargai kerana budi pekerti', 'Tampan kerana pakaian', 'Cantik kerana solekan', 'Kaya kerana harta'] },
    // Pantun 6: Pisang emas dibawa belayar
    { pantunIndex: 5, question: 'Apakah pengajaran pantun "Pisang emas dibawa belayar"?', answer: 'Budi baik orang dikenang selamanya', options: ['Budi baik orang dikenang selamanya', 'Pisang emas mahal harganya', 'Belayar ke pulau jauh', 'Hutang emas perlu dibayar'] },
    { pantunIndex: 5, question: 'Apakah tema pantun "Pisang emas dibawa belayar"?', answer: 'Budi pekerti', options: ['Budi pekerti', 'Pendidikan', 'Kerajinan', 'Kesenangan'] },
    { pantunIndex: 5, question: '"Hutang budi dibawa mati" bermaksud...?', answer: 'Budi baik dikenang sampai bila-bila', options: ['Budi baik dikenang sampai bila-bila', 'Budi itu berat', 'Hutang perlu dibayar', 'Mati membawa budi'] },
  ],
  // ── T1 M4 T4.3: Lagu ─────────────────────────────────────────
  // Listening practice — no quiz.
  '1-4-3-lagu': [],
  ...
  // ── T2 M1 T1.1b: Mendengar Arahan (dengar arahan berbilang langkah → faham butiran) ──
  '2-1-1b-mendengar-arahan': [
    { audioText: 'Buka buku, cari muka surat lima, dan baca ayat pertama.', question: 'Muka surat yang mana perlu dicari?', answer: 'Lima', options: ['Lima', 'Tiga', 'Sepuluh', 'Lapan'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Berdiri, pusing ke kiri, kemudian duduk semula.', question: 'Pusing ke arah mana?', answer: 'Kiri', options: ['Kiri', 'Kanan', 'Belakang', 'Hadapan'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Susun kerusi, kutip sampah, dan padamkan papan tulis.', question: 'Berapa tugas yang diberi?', answer: 'Tiga', options: ['Tiga', 'Dua', 'Empat', 'Satu'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Ambil bakul, masukkan tiga biji epal, dan bawa ke dapur.', question: 'Berapa biji epal perlu dimasukkan?', answer: 'Tiga', options: ['Tiga', 'Dua', 'Lima', 'Empat'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Pakai kasut, ambil beg, dan tunggu di pintu.', question: 'Di mana perlu tunggu?', answer: 'Di pintu', options: ['Di pintu', 'Di dapur', 'Di bilik', 'Di taman'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Lukis matahari, warnakan ia kuning, kemudian lukis awan.', question: 'Apakah warna matahari?', answer: 'Kuning', options: ['Kuning', 'Biru', 'Merah', 'Hijau'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Ambil air, siram pokok bunga, dan simpan baldi.', question: 'Apa yang perlu disiram?', answer: 'Pokok bunga', options: ['Pokok bunga', 'Lantai', 'Kereta', 'Baju'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Buka tingkap, sapu lantai, dan buang sampah ke tong.', question: 'Ke mana sampah dibuang?', answer: 'Ke tong sampah', options: ['Ke tong sampah', 'Ke luar tingkap', 'Ke meja', 'Ke beg'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Ambil pembaris, lukis satu garisan, dan simpan pembaris.', question: 'Apakah alat yang digunakan?', answer: 'Pembaris', options: ['Pembaris', 'Pemadam', 'Gunting', 'Berus'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Petik dua kuntum bunga, masukkan ke dalam pasu, dan letak di meja.', question: 'Berapa kuntum bunga dipetik?', answer: 'Dua', options: ['Dua', 'Tiga', 'Empat', 'Lima'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Buka beg, keluarkan buku Matematik, dan letak di atas meja.', question: 'Buku apa yang perlu dikeluarkan?', answer: 'Buku Matematik', options: ['Buku Matematik', 'Buku Sains', 'Buku BM', 'Buku Nota'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Ambil bola, tendang ke depan, kemudian kutip semula.', question: 'Ke arah mana bola ditendang?', answer: 'Ke depan', options: ['Ke depan', 'Ke belakang', 'Ke kiri', 'Ke kanan'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Warnakan bunga merah, daun hijau, dan langit biru.', question: 'Apakah warna daun?', answer: 'Hijau', options: ['Hijau', 'Merah', 'Biru', 'Kuning'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Ambil sudu, kacau minuman, dan letak di tepi cawan.', question: 'Apa yang digunakan untuk mengacau?', answer: 'Sudu', options: ['Sudu', 'Garpu', 'Pisau', 'Pinggan'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Buka lampu, baca buku selama lima minit, kemudian tutup lampu.', question: 'Berapa lama perlu membaca?', answer: 'Lima minit', options: ['Lima minit', 'Dua minit', 'Sepuluh minit', 'Satu minit'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Ambil dua biji epal dan sebiji oren, letak dalam bakul.', question: 'Berapa biji epal diambil?', answer: 'Dua', options: ['Dua', 'Tiga', 'Empat', 'Satu'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Pakai baju merah dan seluar biru.', question: 'Apakah warna seluar?', answer: 'Biru', options: ['Biru', 'Merah', 'Hijau', 'Kuning'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Cari tiga batang pensel di dalam laci.', question: 'Di mana pensel dicari?', answer: 'Di dalam laci', options: ['Di dalam laci', 'Di atas meja', 'Di dalam beg', 'Di rak buku'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Bawa buku Sains, buku BM, dan kotak warna ke sekolah.', question: 'Berapa barang yang dibawa?', answer: 'Tiga', options: ['Tiga', 'Dua', 'Empat', 'Lima'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
    { audioText: 'Hidupkan kipas, tutup tingkap, dan buka lampu.', question: 'Apa yang dihidupkan?', answer: 'Kipas', options: ['Kipas', 'Lampu', 'TV', 'Radio'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Mendengar-Arahan' },
  ],
  // ── T2 M1 T1.1c: Ikut Susunan (urutkan langkah arahan mengikut turutan yang betul) ──
  '2-1-1c-ikut-susunan': [
    { audioText: 'Ambil pensel merah, lukis sebuah bulatan, kemudian warnakan ia kuning.', question: 'Apakah langkah PERTAMA?', answer: 'Ambil pensel merah', options: ['Ambil pensel merah', 'Lukis bulatan', 'Warnakan kuning', 'Padam bulatan'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Ambil buku biru, letak di atas meja, dan tutup pintu.', question: 'Apakah langkah TERAKHIR?', answer: 'Tutup pintu', options: ['Tutup pintu', 'Ambil buku biru', 'Buka tingkap', 'Letak di lantai'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Lipat baju, masukkan ke dalam almari, dan kemas katil.', question: 'Apakah langkah PERTAMA?', answer: 'Lipat baju', options: ['Lipat baju', 'Kemas katil', 'Basuh baju', 'Sapu lantai'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Basuh tangan, lap hingga kering, kemudian mula makan.', question: 'Apa dibuat SEBELUM makan?', answer: 'Lap tangan kering', options: ['Lap tangan kering', 'Tidur', 'Bermain', 'Menyanyi'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Basuh pinggan, lap meja, dan susun kerusi.', question: 'Apakah langkah KEDUA?', answer: 'Lap meja', options: ['Lap meja', 'Basuh pinggan', 'Susun kerusi', 'Sapu lantai'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Buka buku, tulis nombor, dan bulatkan jawapan.', question: 'Apakah langkah KEDUA?', answer: 'Tulis nombor', options: ['Tulis nombor', 'Buka buku', 'Bulatkan jawapan', 'Baca ayat'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Basuh beras, masak nasi, dan hidang di meja.', question: 'Apakah langkah PERTAMA?', answer: 'Basuh beras', options: ['Basuh beras', 'Masak nasi', 'Hidang di meja', 'Tumis lauk'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Ambil surat khabar, lipat kemas, dan letak di meja.', question: 'Apakah langkah TERAKHIR?', answer: 'Letak di meja', options: ['Letak di meja', 'Ambil surat khabar', 'Lipat kemas', 'Buang surat'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Buka tin, tuang dalam mangkuk, dan panaskan sebentar.', question: 'Apa dibuat SEBELUM memanaskan?', answer: 'Tuang dalam mangkuk', options: ['Tuang dalam mangkuk', 'Buka tin', 'Panaskan sebentar', 'Basuh mangkuk'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Petik cili, basuh bersih, dan potong kecil.', question: 'Langkah yang manakah PALING AKHIR?', answer: 'Potong kecil', options: ['Potong kecil', 'Petik cili', 'Basuh bersih', 'Toskan air'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Ambil kertas, lukis garisan, dan gunting mengikut bentuk.', question: 'Langkah yang manakah PERTAMA?', answer: 'Ambil kertas', options: ['Ambil kertas', 'Lukis garisan', 'Gunting bentuk', 'Warnakan'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Angkat buku, lap habuk, dan susun semula.', question: 'Apakah langkah KEDUA?', answer: 'Lap habuk', options: ['Lap habuk', 'Angkat buku', 'Susun semula', 'Buang buku'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Sukat tepung, campur telur, dan pukul sebati.', question: 'Apa dibuat SELEPAS sukat tepung?', answer: 'Campur telur', options: ['Campur telur', 'Sukat tepung', 'Pukul sebati', 'Masukkan gula'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Dengar arahan, fikir jawapan, dan tulis dalam buku.', question: 'Apa dibuat SETELAH mendengar arahan?', answer: 'Fikir jawapan', options: ['Fikir jawapan', 'Dengar arahan', 'Tulis jawapan', 'Baca semula'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Rendam kacang, toskan air, dan rebus hingga empuk.', question: 'Apakah langkah SELEPAS merendam?', answer: 'Toskan air', options: ['Toskan air', 'Rendam kacang', 'Rebus hingga empuk', 'Bilas bersih'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Cuci berus, buka cat, dan mula melukis.', question: 'Apa perlu dibuat SEBELUM melukis?', answer: 'Buka cat', options: ['Buka cat', 'Cuci berus', 'Mula melukis', 'Ambil air'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Buka muka surat tujuh, baca petikan, dan jawab soalan.', question: 'Apakah langkah PERTAMA?', answer: 'Buka muka surat tujuh', options: ['Buka muka surat tujuh', 'Baca petikan', 'Jawab soalan', 'Tulis nama'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Susun kerusi, sapu lantai, dan mop lantai.', question: 'Apakah langkah TERAKHIR?', answer: 'Mop lantai', options: ['Mop lantai', 'Susun kerusi', 'Sapu lantai', 'Buka tingkap'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Basuh sayur, potong dadu, dan tumis dengan bawang.', question: 'Apakah langkah KEDUA?', answer: 'Potong dadu', options: ['Potong dadu', 'Basuh sayur', 'Tumis bawang', 'Hidang di meja'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
    { audioText: 'Pilih warna, lukis lakaran, dan warnakan gambar.', question: 'Apa dibuat SETELAH memilih warna?', answer: 'Lukis lakaran', options: ['Lukis lakaran', 'Pilih warna', 'Warnakan gambar', 'Gunting gambar'], topic: 'susunan', difficulty: 'mudah', topicId: 'TOPIK 1.1c-Ikut-Susunan' },
  ],
  // ── T2 M1 T1.1d: Pesanan (sampaikan mesej — ingat butiran penting) ──
  '2-1-1d-pesanan': [
    { audioText: 'Sampaikan kepada emak: kelas tambahan akan diadakan pada hari Sabtu pukul lapan pagi.', question: 'Bilakah kelas tambahan diadakan?', answer: 'Hari Sabtu pukul lapan pagi', options: ['Hari Sabtu pukul lapan pagi', 'Hari Ahad pukul lapan pagi', 'Hari Sabtu pukul dua petang', 'Hari Isnin pagi'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Beritahu abang: jemput adik di tadika pada pukul satu petang.', question: 'Pukul berapa adik perlu dijemput?', answer: 'Pukul satu petang', options: ['Pukul satu petang', 'Pukul dua petang', 'Pukul satu pagi', 'Pukul tiga petang'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Beritahu cikgu: Ali sakit dan tidak dapat hadir ke sekolah hari ini.', question: 'Mengapa Ali tidak hadir ke sekolah?', answer: 'Ali sakit', options: ['Ali sakit', 'Ali malas', 'Ali bercuti', 'Ali lewat'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Sampaikan kepada ayah: mesyuarat akan diadakan di sekolah pada pukul lima petang.', question: 'Di manakah mesyuarat diadakan?', answer: 'Di sekolah', options: ['Di sekolah', 'Di rumah', 'Di pejabat', 'Di kedai'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Beritahu nenek: kami akan datang melawat pada hari Ahad.', question: 'Bilakah kami akan datang melawat?', answer: 'Hari Ahad', options: ['Hari Ahad', 'Hari Sabtu', 'Hari Isnin', 'Hari Jumaat'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Beritahu kawan: perjumpaan kelab akan diadakan pada hari Khamis di dewan.', question: 'Di manakah perjumpaan kelab diadakan?', answer: 'Di dewan', options: ['Di dewan', 'Di padang', 'Di kelas', 'Di kantin'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Sampaikan kepada emak: cikgu meminta bayaran buku esok.', question: 'Bilakah bayaran buku perlu dibuat?', answer: 'Esok', options: ['Esok', 'Hari ini', 'Minggu depan', 'Lusa'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Sampaikan kepada cikgu: ibu akan datang berjumpa cikgu pada pukul tiga petang.', question: 'Pukul berapa ibu akan datang?', answer: 'Pukul tiga petang', options: ['Pukul tiga petang', 'Pukul dua petang', 'Pukul tiga pagi', 'Pukul empat petang'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Beritahu adik: makan tengah hari sudah disediakan di dapur.', question: 'Di manakah makan tengah hari disediakan?', answer: 'Di dapur', options: ['Di dapur', 'Di bilik', 'Di taman', 'Di kedai'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Sampaikan kepada ayah: kereta perlu dihantar ke bengkel esok pagi.', question: 'Bilakah kereta perlu dihantar ke bengkel?', answer: 'Esok pagi', options: ['Esok pagi', 'Hari ini', 'Malam ini', 'Lusa'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Beritahu jurulatih: latihan bola sepak ditunda ke hari Selasa.', question: 'Bilakah latihan bola sepak diadakan?', answer: 'Hari Selasa', options: ['Hari Selasa', 'Hari Isnin', 'Hari Rabu', 'Hari Ahad'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Sampaikan kepada emak: saya mendapat nombor satu dalam ujian Matematik.', question: 'Dalam ujian apa saya mendapat nombor satu?', answer: 'Matematik', options: ['Matematik', 'Sains', 'Bahasa Melayu', 'Pendidikan Jasmani'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Beritahu ibu: majlis hari jadi akan diadakan pada hari Sabtu ini.', question: 'Bilakah majlis hari jadi diadakan?', answer: 'Hari Sabtu', options: ['Hari Sabtu', 'Hari Ahad', 'Hari Isnin', 'Hari Jumaat'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Sampaikan kepada ayah: stesen minyak akan ditutup esok.', question: 'Bilakah stesen minyak ditutup?', answer: 'Esok', options: ['Esok', 'Hari ini', 'Lusa', 'Minggu depan'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Beritahu kakak: baju sukan perlu dibawa ke sekolah esok.', question: 'Apakah yang perlu dibawa ke sekolah?', answer: 'Baju sukan', options: ['Baju sukan', 'Buku tulis', 'Makanan', 'Air minum'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Sampaikan kepada emak: kelas tambahan ditunda ke pukul sepuluh pagi.', question: 'Pukul berapa kelas tambahan bermula?', answer: 'Pukul sepuluh pagi', options: ['Pukul sepuluh pagi', 'Pukul lapan pagi', 'Pukul sembilan pagi', 'Pukul sebelas pagi'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Beritahu cikgu: buku latihan sudah siap dikumpulkan.', question: 'Apakah yang sudah siap dikumpulkan?', answer: 'Buku latihan', options: ['Buku latihan', 'Alat tulis', 'Pakaian sukan', 'Makanan ringan'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Sampaikan kepada abang: mesin basuh rosak dan perlu dibaiki.', question: 'Apakah yang rosak?', answer: 'Mesin basuh', options: ['Mesin basuh', 'Peti sejuk', 'Kipas', 'Seterika'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Beritahu nenek: kami akan sampai pada pukul tujuh malam.', question: 'Pukul berapa kami akan sampai?', answer: 'Pukul tujuh malam', options: ['Pukul tujuh malam', 'Pukul lapan malam', 'Pukul enam petang', 'Pukul sembilan pagi'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
    { audioText: 'Sampaikan kepada adik: makan malam akan dihidangkan pada pukul lapan malam.', question: 'Pukul berapa makan malam dihidangkan?', answer: 'Pukul lapan', options: ['Pukul lapan', 'Pukul tujuh', 'Pukul enam', 'Pukul sembilan'], topic: 'pesanan', difficulty: 'mudah', topicId: '2-1-1d' },
  ],
  // ── T2 M1 T1.1e: Permintaan (minta tolong / minta kebenaran dengan sopan) ──
  '2-1-1e-permintaan': [
    { audioText: 'Awak, tolong ambilkan beg biru saya di atas meja itu.', question: 'Apakah warna beg yang diminta?', answer: 'Biru', options: ['Biru', 'Merah', 'Hijau', 'Kuning'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Cikgu, izinkan saya ke tandas dan mengambil air.', question: 'Apakah yang hendak dilakukan selepas ke tandas?', answer: 'Mengambil air', options: ['Mengambil air', 'Makan', 'Balik rumah', 'Tidur'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Kakak, tolong belikan roti dan susu di kedai.', question: 'Apakah yang perlu dibeli?', answer: 'Roti dan susu', options: ['Roti dan susu', 'Nasi dan ayam', 'Buah dan air', 'Gula dan garam'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Abang, tolong baiki basikal merah saya di garaj.', question: 'Di manakah basikal itu berada?', answer: 'Di garaj', options: ['Di garaj', 'Di bilik', 'Di dapur', 'Di taman'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Boleh saya pinjam pemadam dan pembaris awak?', question: 'Apakah yang ingin dipinjam?', answer: 'Pemadam dan pembaris', options: ['Pemadam dan pembaris', 'Pensel dan buku', 'Gunting dan gam', 'Warna dan kertas'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Kakak, tolong ambilkan baju merah saya di ampaian.', question: 'Apakah warna baju yang diminta?', answer: 'Merah', options: ['Merah', 'Biru', 'Kuning', 'Hijau'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Awak, tolong simpan buku ini di dalam rak.', question: 'Di manakah buku perlu disimpan?', answer: 'Di dalam rak', options: ['Di dalam rak', 'Di atas meja', 'Di dalam beg', 'Di lantai'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Abang, tolong belikan tiga batang pensel di kedai.', question: 'Berapa batang pensel yang diminta?', answer: 'Tiga batang', options: ['Tiga batang', 'Dua batang', 'Lima batang', 'Empat batang'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Kakak, tolong ambilkan buku cerita di rak atas.', question: 'Apakah yang diminta?', answer: 'Buku cerita', options: ['Buku cerita', 'Buku latihan', 'Pensel', 'Pembaris'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Ayah, boleh saya pergi ke rumah kawan petang ini?', question: 'Apakah yang diminta daripada ayah?', answer: 'Kebenaran', options: ['Kebenaran', 'Wang', 'Hadiah', 'Nasihat'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Cikgu, boleh terangkan soalan nombor tiga sekali lagi?', question: 'Soalan nombor berapa perlu diterangkan?', answer: 'Nombor tiga', options: ['Nombor tiga', 'Nombor satu', 'Nombor dua', 'Nombor empat'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Emak, tolong belikan pensel warna untuk saya.', question: 'Apakah yang perlu dibeli?', answer: 'Pensel warna', options: ['Pensel warna', 'Buku tulis', 'Pemadam', 'Pembaris'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Cikgu, boleh saya keluar dari kelas sebentar?', question: 'Untuk apakah kebenaran itu diminta?', answer: 'Keluar dari kelas', options: ['Keluar dari kelas', 'Buang sampah', 'Pinjam buku', 'Makan'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Abang, tolong hantarkan surat ini ke pejabat pos.', question: 'Ke manakah surat perlu dihantar?', answer: 'Pejabat pos', options: ['Pejabat pos', 'Pejabat guru', 'Kedai runcit', 'Perpustakaan'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Kakak, boleh saya pinjam payung awak? Hari hujan.', question: 'Apakah yang ingin dipinjam?', answer: 'Payung', options: ['Payung', 'Baju', 'Topi', 'Selimut'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Adik, tolong ambilkan gelas di dapur.', question: 'Apakah yang perlu diambil?', answer: 'Gelas', options: ['Gelas', 'Pinggan', 'Mangkuk', 'Sudu'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Emak, boleh saya bela seekor anak kucing?', question: 'Untuk apakah kebenaran itu diminta?', answer: 'Memelihara anak kucing', options: ['Memelihara anak kucing', 'Memelihara anak ayam', 'Memelihara anak ikan', 'Memelihara anak arnab'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Awak, tolong warnakan poster ini untuk kelas kita.', question: 'Apakah yang perlu dilakukan?', answer: 'Mewarnakan poster', options: ['Mewarnakan poster', 'Menulis karangan', 'Membuat kraf', 'Melukis gambar'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Cikgu, boleh semak ejaan karangan saya?', question: 'Apakah yang perlu disemak?', answer: 'Ejaan karangan', options: ['Ejaan karangan', 'Isi karangan', 'Tajuk karangan', 'Muka surat'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
    { audioText: 'Ayah, tolong baiki basikal saya. Tayarnya pancit.', question: 'Apakah yang perlu dibaiki?', answer: 'Basikal', options: ['Basikal', 'Kereta', 'Meja', 'Pagar'], topic: 'permintaan', difficulty: 'mudah', topicId: '2-1-1e' },
  ],
  // ── T2 M1 T1.2b: Beri Pendapat Baik (give good opinions on situations) ──
  '2-1-2b-beri-pendapat-baik': [
    { emoji: '🤕', question: 'Seorang pakcik terjatuh daripada motosikal. Ali segera membantu pakcik itu bangun.\nPada pendapat kamu, apakah yang telah dilakukan oleh Ali?', answer: 'Ali telah melakukan perbuatan yang baik.', options: ['Ali telah melakukan perbuatan yang baik.', 'Ali tidak perlu membantu pakcik itu.', 'Pakcik itu tidak patut menunggang motosikal.', 'Tiada perkara baik berlaku dalam situasi ini.'], topic: 'beri-pendapat-baik', difficulty: 'mudah', penerangan: 'Membantu orang yang berada dalam kesusahan menunjukkan sikap prihatin dan baik hati.' },
    { emoji: '👩', question: 'Ibu memanggil Iman. Iman mendengar panggilan itu tetapi tidak menyahut.\nPada pendapat kamu, adakah tindakan Iman betul?', answer: 'Iman sepatutnya menyahut panggilan ibunya.', options: ['Tindakan Iman betul.', 'Iman sepatutnya menyahut panggilan ibunya.', 'Ibu tidak patut memanggil Iman.', 'Tiada siapa yang melakukan kesalahan.'], topic: 'beri-pendapat-baik', difficulty: 'mudah', penerangan: 'Menjawab panggilan ibu bapa menunjukkan sikap hormat dan sopan.' },
    { emoji: '✏️', question: 'Siti meminjam pensel daripada kawannya dan memulangkannya selepas digunakan.\nPada pendapat kamu, adakah tindakan Siti baik?', answer: 'Ya, kerana Siti bertanggungjawab.', options: ['Ya, kerana Siti bertanggungjawab.', 'Tidak, kerana dia meminjam pensel.', 'Kawannya tidak patut meminjamkan pensel.', 'Pensel tidak perlu dipulangkan.'], topic: 'beri-pendapat-baik', difficulty: 'mudah', penerangan: 'Memulangkan barang yang dipinjam menunjukkan sikap amanah dan bertanggungjawab.' },
    { emoji: '🗑️', question: 'Amir membuang sampah ke dalam tong sampah selepas makan.\nPada pendapat kamu, apakah pendapat terbaik tentang tindakan Amir?', answer: 'Amir menjaga kebersihan.', options: ['Amir menjaga kebersihan.', 'Amir patut membuang sampah di lantai.', 'Tong sampah tidak perlu digunakan.', 'Tiada perkara baik dilakukan.'], topic: 'beri-pendapat-baik', difficulty: 'mudah', penerangan: 'Membuang sampah ke dalam tong sampah membantu menjaga kebersihan persekitaran.' },
    { emoji: '🙏', question: 'Kumar mengucapkan terima kasih selepas menerima bantuan daripada rakannya.\nPada pendapat kamu, adakah tindakan Kumar wajar?', answer: 'Ya, kerana dia menghargai bantuan.', options: ['Ya, kerana dia menghargai bantuan.', 'Tidak, kerana dia tidak perlu berterima kasih.', 'Rakannya tidak perlu membantu.', 'Ucapan terima kasih tidak penting.'], topic: 'beri-pendapat-baik', difficulty: 'mudah', penerangan: 'Mengucapkan terima kasih menunjukkan sikap menghargai dan berbudi bahasa.' },
    { emoji: '😢', question: 'Aina melihat rakannya menangis kerana kehilangan pemadam. Aina cuba menenangkan rakannya.\nPada pendapat kamu, apakah yang boleh dikatakan tentang tindakan Aina?', answer: 'Aina menunjukkan sikap prihatin.', options: ['Aina menunjukkan sikap prihatin.', 'Aina tidak patut peduli.', 'Rakannya tidak perlu menangis.', 'Tiada siapa perlu membantu.'], topic: 'beri-pendapat-baik', difficulty: 'sederhana', penerangan: 'Menenangkan rakan yang sedih menunjukkan sikap penyayang dan prihatin.' },
    { emoji: '🧍', question: 'Faris beratur dengan sabar semasa membeli makanan di kantin.\nPada pendapat kamu, adakah tindakan Faris betul?', answer: 'Ya, kerana dia mematuhi peraturan.', options: ['Ya, kerana dia mematuhi peraturan.', 'Tidak, kerana dia perlu memotong barisan.', 'Beratur tidak penting.', 'Semua jawapan betul.'], topic: 'beri-pendapat-baik', difficulty: 'sederhana', penerangan: 'Beratur menunjukkan disiplin dan menghormati hak orang lain.' },
    { emoji: '🚰', question: 'Nadia menutup paip air selepas menggunakannya di tandas.\nPada pendapat kamu, apakah pendapat terbaik tentang tindakan Nadia?', answer: 'Nadia berjimat menggunakan air.', options: ['Nadia berjimat menggunakan air.', 'Paip tidak perlu ditutup.', 'Air boleh dibazirkan.', 'Tiada faedah menutup paip.'], topic: 'beri-pendapat-baik', difficulty: 'sederhana', penerangan: 'Menutup paip selepas digunakan mengelakkan pembaziran air.' },
    { emoji: '📚', question: 'Hakim membantu guru membawa buku ke bilik guru.\nPada pendapat kamu, adakah tindakan Hakim baik?', answer: 'Ya, kerana dia suka membantu.', options: ['Ya, kerana dia suka membantu.', 'Tidak, kerana itu bukan tugasnya.', 'Guru perlu membawa sendiri.', 'Membantu tidak penting.'], topic: 'beri-pendapat-baik', difficulty: 'sederhana', penerangan: 'Membantu guru menunjukkan sikap ringan tulang dan hormat kepada guru.' },
    { emoji: '🍱', question: 'Mei Ling berkongsi bekal makanannya dengan rakan yang terlupa membawa makanan.\nPada pendapat kamu, apakah yang boleh dikatakan tentang tindakan Mei Ling?', answer: 'Mei Ling seorang yang suka berkongsi.', options: ['Mei Ling seorang yang suka berkongsi.', 'Dia tidak patut berkongsi.', 'Rakannya tidak perlu makan.', 'Makanan perlu disimpan sendiri.'], topic: 'beri-pendapat-baik', difficulty: 'sederhana', penerangan: 'Berkongsi dengan orang lain menunjukkan sikap pemurah dan baik hati.' },
    { emoji: '🙇', question: 'Daniel meminta maaf selepas tidak sengaja melanggar rakannya.\nPada pendapat kamu, adakah tindakan Daniel betul?', answer: 'Ya, kerana dia mengakui kesilapannya.', options: ['Ya, kerana dia mengakui kesilapannya.', 'Tidak, kerana dia tidak perlu meminta maaf.', 'Rakannya yang perlu meminta maaf.', 'Tiada siapa bersalah.'], topic: 'beri-pendapat-baik', difficulty: 'sederhana', penerangan: 'Meminta maaf menunjukkan sikap bertanggungjawab dan berani mengakui kesalahan.' },
    { emoji: '👛', question: 'Sara mengembalikan dompet yang dijumpainya kepada pemiliknya.\nPada pendapat kamu, apakah pendapat terbaik tentang tindakan Sara?', answer: 'Sara seorang yang jujur.', options: ['Sara seorang yang jujur.', 'Sara patut menyimpan dompet itu.', 'Pemilik dompet cuai.', 'Dompet itu tidak perlu dipulangkan.'], topic: 'beri-pendapat-baik', difficulty: 'sederhana', penerangan: 'Memulangkan barang yang dijumpai menunjukkan sifat jujur dan amanah.' },
    { emoji: '🧑‍🤝‍🧑', question: 'Rakan-rakan Amir mengejek murid baharu. Amir tidak turut mengejek dan mengajak murid itu bermain bersama.\nPada pendapat kamu, apakah yang telah dilakukan oleh Amir?', answer: 'Amir menunjukkan sikap baik dan berani.', options: ['Amir menunjukkan sikap baik dan berani.', 'Amir patut ikut mengejek.', 'Murid baharu perlu dibiarkan sendiri.', 'Tiada perkara baik berlaku.'], topic: 'beri-pendapat-baik', difficulty: 'sukar', penerangan: 'Menghormati dan menerima rakan baharu menunjukkan sikap baik hati dan berani melakukan perkara yang betul.' },
    { emoji: '💡', question: 'Aisyah ternampak lampu kelas masih menyala walaupun semua murid sudah keluar. Dia menutup lampu tersebut.\nPada pendapat kamu, adakah tindakan Aisyah wajar?', answer: 'Ya, kerana dia mengelakkan pembaziran elektrik.', options: ['Ya, kerana dia mengelakkan pembaziran elektrik.', 'Tidak, lampu perlu dibiarkan menyala.', 'Lampu bukan tanggungjawab sesiapa.', 'Elektrik boleh dibazirkan.'], topic: 'beri-pendapat-baik', difficulty: 'sukar', penerangan: 'Menutup lampu yang tidak digunakan membantu menjimatkan tenaga elektrik.' },
    { emoji: '💰', question: 'Rafiq menjumpai wang di lantai sekolah lalu menyerahkannya kepada guru.\nPada pendapat kamu, apakah pendapat terbaik tentang tindakan Rafiq?', answer: 'Rafiq seorang yang amanah.', options: ['Rafiq seorang yang amanah.', 'Rafiq patut mengambil wang itu.', 'Guru tidak perlu tahu.', 'Wang itu boleh disimpan.'], topic: 'beri-pendapat-baik', difficulty: 'sukar', penerangan: 'Menyerahkan wang yang dijumpai kepada guru menunjukkan sifat amanah dan jujur.' },
    { emoji: '👵', question: 'Seorang nenek membawa banyak barang. Hana membantu membawa sebahagian barang tersebut.\nPada pendapat kamu, adakah tindakan Hana baik?', answer: 'Ya, kerana dia membantu orang yang memerlukan.', options: ['Ya, kerana dia membantu orang yang memerlukan.', 'Tidak, kerana dia perlu berjalan sendiri.', 'Nenek itu tidak perlu dibantu.', 'Barang itu patut dibiarkan sahaja.'], topic: 'beri-pendapat-baik', difficulty: 'sukar', penerangan: 'Membantu warga emas menunjukkan sikap hormat dan prihatin terhadap orang lain.' },
    { emoji: '🖊️', question: 'Adam menegur rakannya yang menconteng meja sekolah.\nPada pendapat kamu, apakah yang boleh dikatakan tentang tindakan Adam?', answer: 'Adam menjaga harta benda sekolah.', options: ['Adam menjaga harta benda sekolah.', 'Adam patut turut menconteng.', 'Meja sekolah tidak perlu dijaga.', 'Tiada masalah menconteng meja.'], topic: 'beri-pendapat-baik', difficulty: 'sukar', penerangan: 'Menjaga kemudahan sekolah merupakan tanggungjawab semua murid.' },
    { emoji: '🏆', question: 'Kelas Nurul menjadi juara pertandingan kebersihan kerana semua murid bekerjasama membersihkan kelas.\nPada pendapat kamu, mengapa kelas Nurul berjaya?', answer: 'Kerana semua murid bekerjasama.', options: ['Kerana semua murid bekerjasama.', 'Kerana seorang murid sahaja bekerja.', 'Kerana kelas itu paling besar.', 'Kerana mereka tidak membersihkan kelas.'], topic: 'beri-pendapat-baik', difficulty: 'sukar', penerangan: 'Kerjasama membantu mencapai kejayaan dengan lebih mudah.' },
    { emoji: '📖', question: 'Zul membantu adiknya menyiapkan kerja sekolah dengan menerangkan cara menjawab soalan.\nPada pendapat kamu, adakah tindakan Zul baik?', answer: 'Ya, kerana dia membantu adiknya belajar.', options: ['Ya, kerana dia membantu adiknya belajar.', 'Tidak, kerana dia tidak perlu membantu.', 'Adiknya tidak perlu belajar.', 'Kerja sekolah tidak penting.'], topic: 'beri-pendapat-baik', difficulty: 'sukar', penerangan: 'Membantu orang lain memahami pelajaran menunjukkan sikap penyayang dan bertanggungjawab.' },
    { emoji: '🌳', question: 'Selepas bermain di taman, semua sampah dikutip dan dibuang ke dalam tong sampah oleh Nabil dan rakan-rakannya.\nPada pendapat kamu, apakah pendapat terbaik tentang tindakan mereka?', answer: 'Mereka menjaga kebersihan alam sekitar.', options: ['Mereka menjaga kebersihan alam sekitar.', 'Sampah patut ditinggalkan di taman.', 'Tong sampah tidak perlu digunakan.', 'Kebersihan bukan tanggungjawab mereka.'], topic: 'beri-pendapat-baik', difficulty: 'sukar', penerangan: 'Menjaga kebersihan persekitaran menjadikan tempat awam lebih selesa dan sihat untuk semua.' },
  ],
  // ── T2 M1 T1.2c: Nilai Murni (identify the right value through actions) ──
  '2-1-2c-nilai-murni': [
    { emoji: '👛', question: 'Kamu jumpa dompet. Apa patut kamu buat?', answer: 'Beri kepada guru.', options: ['Beri kepada guru.', 'Simpan duitnya.', 'Buang dompet itu.', 'Biarkan sahaja.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🧹', question: 'Kelas kotor selepas rehat. Apa patut murid buat?', answer: 'Bersihkan bersama-sama.', options: ['Bersihkan bersama-sama.', 'Tunggu orang lain.', 'Biarkan sahaja.', 'Tambah lagi sampah.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🌧️', question: 'Hujan turun waktu rehat. Apa patut kamu buat?', answer: 'Berteduh di tempat selamat.', options: ['Berteduh di tempat selamat.', 'Bermain dalam hujan.', 'Berlari di tempat licin.', 'Basahkan kawan.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🗑️', question: 'Nampak sampah di lantai. Apa patut kamu buat?', answer: 'Buang ke tong sampah.', options: ['Buang ke tong sampah.', 'Tendang ke tepi.', 'Biarkan sahaja.', 'Pijak sampah itu.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🚰', question: 'Paip air terbuka. Apa patut kamu buat?', answer: 'Tutup paip itu.', options: ['Tutup paip itu.', 'Biarkan sahaja.', 'Main dengan air.', 'Lari pergi.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🚦', question: 'Ketika melintas jalan. Apa patut kamu buat?', answer: 'Guna jejantas.', options: ['Guna jejantas.', 'Lari lintas jalan.', 'Main di jalan raya.', 'Tunggu tepi jalan.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '💰', question: 'Jumpa wang di lantai kelas. Apa patut kamu buat?', answer: 'Serah pada cikgu.', options: ['Serah pada cikgu.', 'Ambil untuk diri.', 'Sorok wang itu.', 'Biarkan sahaja.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🌳', question: 'Pokok di taman patah. Apa patut kamu buat?', answer: 'Laporkan kepada pengawas.', options: ['Laporkan kepada pengawas.', 'Pijak dahan itu.', 'Biarkan sahaja.', 'Petik daunnya.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🍽️', question: 'Makan di kantin. Apa patut kamu buat?', answer: 'Beratur dengan tertib.', options: ['Beratur dengan tertib.', 'Potong barisan.', 'Buat bising.', 'Tolak kawan.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🎮', question: 'Kawan mahu pinjam alat permainan. Apa patut kamu buat?', answer: 'Pinjamkan dengan baik.', options: ['Pinjamkan dengan baik.', 'Enggan beri.', 'Sorok permainan.', 'Marah dia.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🏠', question: 'Dalam perpustakaan. Apa patut kamu buat?', answer: 'Bercakap perlahan-lahan.', options: ['Bercakap perlahan-lahan.', 'Berlari-lari.', 'Buat bising.', 'Main kejar-kejar.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🚲', question: 'Kawan takut menunggang basikal. Apa patut kamu buat?', answer: 'Ajar dengan sabar.', options: ['Ajar dengan sabar.', 'Ketawakan dia.', 'Tunggu saja.', 'Tinggalkan dia.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🌺', question: 'Nampak bunga di taman sekolah. Apa patut kamu buat?', answer: 'Biarkan bunga itu.', options: ['Biarkan bunga itu.', 'Petik bunga itu.', 'Pijak bunga itu.', 'Baling bunga.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🗣️', question: 'Kawan bercakap dengan kamu. Apa patut kamu buat?', answer: 'Dengar dan balas dengan sopan.', options: ['Dengar dan balas dengan sopan.', 'Abaikan dia.', 'Potong percakapan.', 'Buat bising.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🧑‍🏫', question: 'Guru memberi tugasan. Apa patut kamu buat?', answer: 'Buat dengan bersungguh-sungguh.', options: ['Buat dengan bersungguh-sungguh.', 'Tiru kawan.', 'Buat sambil lewa.', 'Tidak siapkan.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🏅', question: 'Kawan menang pertandingan. Apa patut kamu buat?', answer: 'Ucap tahniah.', options: ['Ucap tahniah.', 'Dengki padanya.', 'Ejek dia.', 'Buat tidak tahu.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🤲', question: 'Dapat rezeki lebih. Apa patut kamu buat?', answer: 'Kongsi dengan kawan.', options: ['Kongsi dengan kawan.', 'Simpan sendiri.', 'Buang lebihan.', 'Sorok makanan.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🧹', question: 'Tandas kotor selepas guna. Apa patut kamu buat?', answer: 'Bersihkan selepas guna.', options: ['Bersihkan selepas guna.', 'Biarkan kotor.', 'Tambah kotor.', 'Lari pergi.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🎁', question: 'Terima hadiah daripada kawan. Apa patut kamu buat?', answer: 'Ucap terima kasih.', options: ['Ucap terima kasih.', 'Buka terus tanpa cakap.', 'Buang hadiah.', 'Marah kawan.'], topic: 'nilai-murni', difficulty: 'mudah' },
    { emoji: '🌏', question: 'Nampak rakan dibuli. Apa patut kamu buat?', answer: 'Laporkan kepada guru.', options: ['Laporkan kepada guru.', 'Tolong pembuli.', 'Ketawakan.', 'Buat tidak nampak.'], topic: 'nilai-murni', difficulty: 'mudah' },
  ],
  ...
  // ── T1 M5 T5.1: Kata Nama Am & Khas ────────────────────────────
  // Identifying common vs proper nouns in Malay.
  '1-5-1-morfologi-kata': [
    ...
    { question: '"buku" ialah?', emoji: '📚', answer: 'Kata Nama Am', options: ['Kata Nama Am', 'Kata Nama Khas', 'Kata Kerja', 'Kata Adjektif'] },
    { question: '"meja" ialah?', emoji: '🪑', answer: 'Kata Nama Am', options: ['Kata Nama Am', 'Kata Nama Khas', 'Kata Kerja', 'Kata Adjektif'] },
    { question: '"bola" ialah?', emoji: '⚽', answer: 'Kata Nama Am', options: ['Kata Nama Am', 'Kata Nama Khas', 'Kata Kerja', 'Kata Adjektif'] },
    { question: '"rumah" ialah?', emoji: '🏠', answer: 'Kata Nama Am', options: ['Kata Nama Am', 'Kata Nama Khas', 'Kata Kerja', 'Kata Adjektif'] },
    { question: '"baju" ialah?', emoji: '👕', answer: 'Kata Nama Am', options: ['Kata Nama Am', 'Kata Nama Khas', 'Kata Kerja', 'Kata Adjektif'] },
    ...
    { question: '"Siti" ialah?', emoji: '👧', answer: 'Kata Nama Khas', options: ['Kata Nama Khas', 'Kata Nama Am', 'Kata Kerja', 'Kata Adjektif'] },
    { question: '"Pulau Pinang" ialah?', emoji: '🏝️', answer: 'Kata Nama Khas', options: ['Kata Nama Khas', 'Kata Nama Am', 'Kata Kerja', 'Kata Adjektif'] },
    { question: '"Cikgu Anita" ialah?', emoji: '👩‍🏫', answer: 'Kata Nama Khas', options: ['Kata Nama Khas', 'Kata Nama Am', 'Kata Kerja', 'Kata Adjektif'] },
    { question: '"Kuala Lumpur" ialah?', emoji: '🏙️', answer: 'Kata Nama Khas', options: ['Kata Nama Khas', 'Kata Nama Am', 'Kata Kerja', 'Kata Adjektif'] },
    { question: '"Si Comel" (nama kucing) ialah?', emoji: '🐈', answer: 'Kata Nama Khas', options: ['Kata Nama Khas', 'Kata Nama Am', 'Kata Kerja', 'Kata Adjektif'] },
  ],
  // ── T1 M5 T5.2: Kata Kerja & Adjektif ─────────────────────────
  // Identifying verbs and adjectives in Malay.
  '1-5-6-kerja-adjektif': [
    // ── Kata Kerja (verbs) ──
    ...
    { question: '"memasak" ialah?', emoji: '🍳', answer: 'Kata Kerja', options: ['Kata Kerja', 'Kata Nama Am', 'Kata Adjektif', 'Kata Nama Khas'] },
    { question: '"menulis" ialah?', emoji: '✏️', answer: 'Kata Kerja', options: ['Kata Kerja', 'Kata Nama Am', 'Kata Adjektif', 'Kata Nama Khas'] },
    { question: '"melukis" ialah?', emoji: '🎨', answer: 'Kata Kerja', options: ['Kata Kerja', 'Kata Nama Am', 'Kata Adjektif', 'Kata Nama Khas'] },
    { question: '"menyanyi" ialah?', emoji: '🎤', answer: 'Kata Kerja', options: ['Kata Kerja', 'Kata Nama Am', 'Kata Adjektif', 'Kata Nama Khas'] },
    { question: '"berenang" ialah?', emoji: '🏊', answer: 'Kata Kerja', options: ['Kata Kerja', 'Kata Nama Am', 'Kata Adjektif', 'Kata Nama Khas'] },
    ...
    { question: '"merah" ialah?', emoji: '🔴', answer: 'Kata Adjektif', options: ['Kata Adjektif', 'Kata Nama Am', 'Kata Kerja', 'Kata Nama Khas'] },
    { question: '"bulat" ialah?', emoji: '⭕', answer: 'Kata Adjektif', options: ['Kata Adjektif', 'Kata Nama Am', 'Kata Kerja', 'Kata Nama Khas'] },
    { question: '"tinggi" ialah?', emoji: '📏', answer: 'Kata Adjektif', options: ['Kata Adjektif', 'Kata Nama Am', 'Kata Kerja', 'Kata Nama Khas'] },
    { question: '"comel" ialah?', emoji: '🐣', answer: 'Kata Adjektif', options: ['Kata Adjektif', 'Kata Nama Am', 'Kata Kerja', 'Kata Nama Khas'] },
    { question: '"laju" ialah?', emoji: '🚀', answer: 'Kata Adjektif', options: ['Kata Adjektif', 'Kata Nama Am', 'Kata Kerja', 'Kata Nama Khas'] },
  ],
  // ── T1 M5 T5.3: Kata Hubung & Kata Sendi Nama ────────────────
  // Conjunctions (dan, atau, tetapi) and prepositions (di, ke, dari, pada).
  '1-5-7-hubung-sendi': [
    ...
    { question: '"Saya suka membaca ___ melukis." Pilih kata hubung yang BETUL.', answer: 'dan', options: ['dan', 'tetapi', 'atau', 'ke'] },
    { question: '"Ahmad suka bola, ___ Siti suka melukis." Pilih kata hubung yang BETUL.', answer: 'tetapi', options: ['dan', 'tetapi', 'atau', 'di'] },
    { question: '"Awak mahu minum air ___ jus?" Pilih kata hubung yang BETUL.', answer: 'atau', options: ['dan', 'tetapi', 'atau', 'dari'] },
    { question: '"Kucing itu comel ___ manja." Pilih kata hubung yang BETUL.', answer: 'dan', options: ['dan', 'tetapi', 'atau', 'ke'] },
    // ── Kata Sendi Nama (prepositions) ──
    ...
    { question: '"Ibu pergi ___ pasar." Pilih kata sendi nama yang BETUL.', answer: 'ke', options: ['di', 'ke', 'dari', 'pada'] },
    { question: '"Adik bermain ___ taman." Pilih kata sendi nama yang BETUL.', answer: 'di', options: ['di', 'ke', 'dari', 'pada'] },
    { question: '"Ayah pulang ___ pejabat." Pilih kata sendi nama yang BETUL.', answer: 'dari', options: ['di', 'ke', 'dari', 'pada'] },
    { question: '"Buku itu ada ___ atas meja." Pilih kata sendi nama yang BETUL.', answer: 'di', options: ['di', 'ke', 'dari', 'pada'] },
  ],
  // ── T1 M5 T5.4: Kata Tanya & Kata Ganti Nama Diri ─────────────
  // Question words and personal pronouns.
  '1-5-8-tanya-ganti': [
    ...
    { question: '"___ awak lahir?" Pilih kata tanya yang BETUL.', answer: 'Bila', options: ['Bila', 'Apa', 'Siapa', 'Di mana'] },
    { question: '"___ harga buku ini?" Pilih kata tanya yang BETUL.', answer: 'Berapa', options: ['Berapa', 'Apa', 'Siapa', 'Bila'] },
    { question: '"___ yang memecahkan pinggan?" Pilih kata tanya yang BETUL.', answer: 'Siapa', options: ['Siapa', 'Apa', 'Mengapa', 'Bila'] },
    ...
    { question: '"___ semua suka bermain bola." (tunjuk sekumpulan termasuk diri)', emoji: '👥', answer: 'Kami', options: ['Kami', 'Kita', 'Mereka', 'Dia'] },
    { question: '"______ tinggal di kampung." (tunjuk orang ketiga ramai)', emoji: '👨‍👩‍👧‍👦', answer: 'Mereka', options: ['Mereka', 'Kami', 'Kita', 'Kamu'] },
    { question: '"______ hendak ke mana?" (tanya kepada seorang)', emoji: '🙋', answer: 'Kamu', options: ['Kamu', 'Saya', 'Dia', 'Mereka'] },
    { question: '"______ suka makan nasi lemak." (bercakap tentang diri)', emoji: '😊', answer: 'Saya', options: ['Saya', 'Kamu', 'Dia', 'Kita'] },
  ],
