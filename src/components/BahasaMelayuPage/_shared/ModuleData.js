...
export const BM_QUESTIONS = {
  ...
  '2-1-2b-berbincang': [
    { emoji: '🚲', question: 'Kawan jatuh basikal. Apa patut kamu buat?', answer: 'Tolong kawan bangun.', options: ['Tolong kawan bangun.', 'Ketawakan dia.', 'Lari pergi.', 'Buat tidak nampak.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '👛', question: 'Kamu jumpa dompet. Apa patut kamu buat?', answer: 'Beri kepada guru.', options: ['Beri kepada guru.', 'Simpan duitnya.', 'Buang dompet itu.', 'Biarkan sahaja.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '😢', question: 'Kawan nampak sedih. Apa patut kamu buat?', answer: 'Tanya dan pujuk dia.', options: ['Tanya dan pujuk dia.', 'Abaikan dia.', 'Ketawakan dia.', 'Marah dia.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '🧹', question: 'Kelas kotor selepas rehat. Apa patut murid buat?', answer: 'Bersihkan bersama-sama.', options: ['Bersihkan bersama-sama.', 'Tunggu orang lain.', 'Biarkan sahaja.', 'Tambah lagi sampah.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '🙋', question: 'Tidak faham soalan cikgu. Apa patut kamu buat?', answer: 'Angkat tangan dan tanya.', options: ['Angkat tangan dan tanya.', 'Diam sahaja.', 'Tiru kawan.', 'Biarkan kosong.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '🧸', question: 'Adik mahu pinjam mainan. Apa patut kamu buat?', answer: 'Berkongsi dengan adik.', options: ['Berkongsi dengan adik.', 'Rampas semula.', 'Marah adik.', 'Sorok mainan.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '🧑‍🤝‍🧑', question: 'Murid baharu duduk sendiri. Apa patut kamu buat?', answer: 'Ajak dia bermain.', options: ['Ajak dia bermain.', 'Biarkan dia.', 'Ketawakan dia.', 'Ganggu dia.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '🌧️', question: 'Hujan turun waktu rehat. Apa patut kamu buat?', answer: 'Berteduh di tempat selamat.', options: ['Berteduh di tempat selamat.', 'Bermain dalam hujan.', 'Berlari di tempat licin.', 'Basahkan kawan.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '🙇', question: 'Terpijak kaki kawan. Apa patut kamu kata?', answer: 'Maaf, saya tidak sengaja.', options: ['Maaf, saya tidak sengaja.', 'Diam sahaja.', 'Marah dia.', 'Lari pergi.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '👂', question: 'Cikgu sedang bercakap. Apa patut kamu buat?', answer: 'Dengar dengan teliti.', options: ['Dengar dengan teliti.', 'Berbual dengan kawan.', 'Tidur di meja.', 'Bermain di belakang.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '📝', question: 'Markah ujian rendah. Apa patut kamu buat?', answer: 'Belajar lebih rajin.', options: ['Belajar lebih rajin.', 'Putus asa.', 'Salahkan cikgu.', 'Sorok kertas ujian.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '✏️', question: 'Kawan lupa bawa pensel. Apa patut kamu buat?', answer: 'Pinjamkan pensel.', options: ['Pinjamkan pensel.', 'Biarkan dia.', 'Ejek dia.', 'Sorok pensel.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '🗑️', question: 'Nampak sampah di lantai. Apa patut kamu buat?', answer: 'Buang ke tong sampah.', options: ['Buang ke tong sampah.', 'Tendang ke tepi.', 'Biarkan sahaja.', 'Pijak sampah itu.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '📚', question: 'Kawan tidak siap kerja. Apa patut kamu buat?', answer: 'Terangkan cara membuatnya.', options: ['Terangkan cara membuatnya.', 'Beri jawapan terus.', 'Biarkan dia.', 'Ejek dia.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '⚽', question: 'Mahu guna bola sama. Apa patut kamu buat?', answer: 'Bermain bergilir-gilir.', options: ['Bermain bergilir-gilir.', 'Berebut bola.', 'Simpan bola sendiri.', 'Merajuk.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '🚰', question: 'Paip air terbuka. Apa patut kamu buat?', answer: 'Tutup paip itu.', options: ['Tutup paip itu.', 'Biarkan sahaja.', 'Main dengan air.', 'Lari pergi.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '📖', question: 'Kawan tersalah membaca. Apa patut kamu buat?', answer: 'Bantu dengan sopan.', options: ['Bantu dengan sopan.', 'Jerit jawapan.', 'Ketawakan dia.', 'Ejek dia.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '📚', question: 'Murid bawa banyak buku. Apa patut kamu buat?', answer: 'Tawarkan bantuan.', options: ['Tawarkan bantuan.', 'Biarkan dia.', 'Ketawakan dia.', 'Jauhkan diri.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '🥤', question: 'Kawan tertinggal bekas air. Apa patut kamu buat?', answer: 'Beritahu kawan itu.', options: ['Beritahu kawan itu.', 'Ambil untuk diri sendiri.', 'Biarkan sahaja.', 'Sorok bekas air.'], topic: 'berbincang', difficulty: 'mudah' },
    { emoji: '🤝', question: 'Kawan tidak faham tugasan. Apa patut kamu buat?', answer: 'Terangkan tugasan.', options: ['Terangkan tugasan.', 'Buat kerja untuknya.', 'Abaikan dia.', 'Suruh dia diam.'], topic: 'berbincang', difficulty: 'mudah' },
  ],
