import {
  ...
  M2_M1T1, M2_M1T2,
  M2_M2T1, M2_M2T2, M2_M2T3,
  M2_M3T1, M2_M3T2, M2_M3T3,
  M2_M4T1, M2_M4T2,
  M2_M5T1, M2_M5T2, M2_M5T3,
} from './BMJourneySvgs';
...
const T2_MODULES = [
  buildModule(1,
    ...
    M1Badge, M1_THEME, 2, [
      ...
      { id: '2-1-1b-mendengar-arahan',      num: '1.1b', label: 'Mendengar Arahan',       icon: M2_M1T1, disabled: false },
      { id: '2-1-1c-ikut-susunan',          num: '1.1c', label: 'Ikut Susunan',            icon: M2_M1T1, disabled: false },
      { id: '2-1-1d-pesanan',               num: '1.1d', label: 'Pesanan',                 icon: M2_M1T1, disabled: false },
      { id: '2-1-1e-permintaan',           num: '1.1e', label: 'Permintaan',              icon: M2_M1T1, disabled: false },
      { id: '2-1-2a-bercerita',  num: '1.2a', label: 'Bercerita (Baca Kuat)', icon: M2_M1T2, disabled: false },
      { id: '2-1-2b-beri-pendapat-baik', num: '1.2b', label: 'Beri Pendapat Baik',            icon: M2_M1T2, disabled: false },
      { id: '2-1-2c-nilai-murni',        num: '1.2c', label: 'Nilai Murni',                  icon: M2_M1T2, disabled: false },
    ]),
  buildModule(2,
    'Kemahiran Membaca',
    'Reading Skills',
    M2Badge, M2_THEME, 2, [
      { id: '2-2-1-perkataan-sukar',      num: '2.1', label: 'Perkataan Sukar (Digraf & Diftong)',  icon: M2_M2T1, disabled: false },
      { id: '2-2-2-teks-pelbagai',        num: '2.2', label: 'Membaca Teks Pelbagai Gaya',          icon: M2_M2T2, disabled: false },
      { id: '2-2-3-mentafsir-menaakul',   num: '2.3', label: 'Membaca, Mentafsir & Menaakul',       icon: M2_M2T3, disabled: false },
    ]),
  buildModule(3,
    'Kemahiran Menulis',
    'Writing Skills',
    M3Badge, M3_THEME, 2, [
      { id: '2-3-1-menulis-mekanis',      num: '3.1', label: 'Menulis secara Mekanis',              icon: M2_M3T1, disabled: false },
      { id: '2-3-2-hasilkan-penulisan',   num: '3.2', label: 'Membina & Menghasilkan Penulisan',    icon: M2_M3T2, disabled: false },
      { id: '2-3-3-jawapan-pemahaman',    num: '3.3', label: 'Menulis Jawapan Pemahaman',           icon: M2_M3T3, disabled: false },
    ]),
  buildModule(4,
    'Aspek Seni Bahasa',
    'Language Arts',
    M4Badge, M4_THEME, 2, [
      { id: '2-4-1-apresiasi-sastera',    num: '4.1', label: 'Apresiasi Sastera Kanak-kanak',      icon: M2_M4T1, disabled: false },
      { id: '2-4-2-persembahan-karya',    num: '4.2', label: 'Persembahan Karya',                  icon: M2_M4T2, disabled: false },
    ]),
  buildModule(5,
    'Aspek Tatabahasa',
    'Grammar',
