...
export const BM_QUESTIONS = {
  ...
  '2-1-1b-arahan': [
    { audioText: 'Ambil pensel merah, lukis sebuah bulatan, kemudian warnakan ia kuning.', question: 'Apakah langkah PERTAMA?', answer: 'Ambil pensel merah', options: ['Ambil pensel merah', 'Lukis bulatan', 'Warnakan kuning', 'Padam bulatan'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Buka buku, cari muka surat lima, dan baca ayat pertama.', question: 'Muka surat yang mana perlu dicari?', answer: 'Lima', options: ['Lima', 'Tiga', 'Sepuluh', 'Lapan'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Berdiri, pusing ke kiri, kemudian duduk semula.', question: 'Pusing ke arah mana?', answer: 'Kiri', options: ['Kiri', 'Kanan', 'Belakang', 'Hadapan'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Ambil buku biru, letak di atas meja, dan tutup pintu.', question: 'Apakah langkah TERAKHIR?', answer: 'Tutup pintu', options: ['Tutup pintu', 'Ambil buku biru', 'Buka tingkap', 'Letak di lantai'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Susun kerusi, kutip sampah, dan padamkan papan tulis.', question: 'Berapa tugas yang diberi?', answer: 'Tiga', options: ['Tiga', 'Dua', 'Empat', 'Satu'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Ambil bakul, masukkan tiga biji epal, dan bawa ke dapur.', question: 'Berapa biji epal perlu dimasukkan?', answer: 'Tiga', options: ['Tiga', 'Dua', 'Lima', 'Empat'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Pakai kasut, ambil beg, dan tunggu di pintu.', question: 'Di mana perlu tunggu?', answer: 'Di pintu', options: ['Di pintu', 'Di dapur', 'Di bilik', 'Di taman'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Lukis matahari, warnakan ia kuning, kemudian lukis awan.', question: 'Apakah warna matahari?', answer: 'Kuning', options: ['Kuning', 'Biru', 'Merah', 'Hijau'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Ambil air, siram pokok bunga, dan simpan baldi.', question: 'Apa yang perlu disiram?', answer: 'Pokok bunga', options: ['Pokok bunga', 'Lantai', 'Kereta', 'Baju'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Lipat baju, masukkan ke dalam almari, dan kemas katil.', question: 'Apakah langkah PERTAMA?', answer: 'Lipat baju', options: ['Lipat baju', 'Kemas katil', 'Basuh baju', 'Sapu lantai'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Basuh tangan, lap hingga kering, kemudian mula makan.', question: 'Apa dibuat sebelum makan?', answer: 'Lap tangan kering', options: ['Lap tangan kering', 'Tidur', 'Bermain', 'Menyanyi'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Buka tingkap, sapu lantai, dan buang sampah ke tong.', question: 'Ke mana sampah dibuang?', answer: 'Ke tong sampah', options: ['Ke tong sampah', 'Ke luar tingkap', 'Ke meja', 'Ke beg'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Ambil pembaris, lukis satu garisan, dan simpan pembaris.', question: 'Apakah alat yang digunakan?', answer: 'Pembaris', options: ['Pembaris', 'Pemadam', 'Gunting', 'Berus'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Petik dua kuntum bunga, masukkan ke dalam pasu, dan letak di meja.', question: 'Berapa kuntum bunga dipetik?', answer: 'Dua', options: ['Dua', 'Tiga', 'Empat', 'Lima'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Buka beg, keluarkan buku Matematik, dan letak di atas meja.', question: 'Buku apa yang perlu dikeluarkan?', answer: 'Buku Matematik', options: ['Buku Matematik', 'Buku Sains', 'Buku BM', 'Buku Nota'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Basuh pinggan, lap meja, dan susun kerusi.', question: 'Apakah langkah KEDUA?', answer: 'Lap meja', options: ['Lap meja', 'Basuh pinggan', 'Susun kerusi', 'Sapu lantai'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Ambil bola, tendang ke depan, kemudian kutip semula.', question: 'Ke arah mana bola ditendang?', answer: 'Ke depan', options: ['Ke depan', 'Ke belakang', 'Ke kiri', 'Ke kanan'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Warnakan bunga merah, daun hijau, dan langit biru.', question: 'Apakah warna daun?', answer: 'Hijau', options: ['Hijau', 'Merah', 'Biru', 'Kuning'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Ambil sudu, kacau minuman, dan letak di tepi cawan.', question: 'Apa yang digunakan untuk mengacau?', answer: 'Sudu', options: ['Sudu', 'Garpu', 'Pisau', 'Pinggan'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
    { audioText: 'Buka lampu, baca buku selama lima minit, kemudian tutup lampu.', question: 'Berapa lama perlu membaca?', answer: 'Lima minit', options: ['Lima minit', 'Dua minit', 'Sepuluh minit', 'Satu minit'], topic: 'arahan', difficulty: 'mudah', topicId: 'TOPIK 1.1b-Melaksanakan-Arahan' },
  ],
  ...
  '2-1-1c-pesanan-permintaan': [
    ...
    { audioText: 'Sampaikan kepada cikgu: ibu akan datang berjumpa pada pukul tiga petang.', question: 'Pukul berapa ibu akan datang?', answer: 'Pukul tiga petang', options: ['Pukul tiga petang', 'Pukul dua petang', 'Pukul tiga pagi', 'Pukul empat petang'], topic: 'pesanan-permintaan', difficulty: 'mudah' },
    { audioText: 'Minta tolong kakak ambil baju merah di ampaian.', question: 'Apakah warna baju yang diminta?', answer: 'Merah', options: ['Merah', 'Biru', 'Kuning', 'Hijau'], topic: 'pesanan-permintaan', difficulty: 'mudah' },
    { audioText: 'Beritahu adik: makan tengah hari sudah sedia di dapur.', question: 'Di mana makanan disediakan?', answer: 'Di dapur', options: ['Di dapur', 'Di bilik', 'Di taman', 'Di kedai'], topic: 'pesanan-permintaan', difficulty: 'mudah' },
    { audioText: 'Sampaikan kepada ayah: kereta perlu dihantar ke bengkel esok pagi.', question: 'Bila kereta perlu dihantar?', answer: 'Esok pagi', options: ['Esok pagi', 'Hari ini', 'Malam ini', 'Lusa'], topic: 'pesanan-permintaan', difficulty: 'mudah' },
    { audioText: 'Minta tolong kawan simpan buku ini di dalam rak.', question: 'Di mana buku perlu disimpan?', answer: 'Di dalam rak', options: ['Di dalam rak', 'Di atas meja', 'Di dalam beg', 'Di lantai'], topic: 'pesanan-permintaan', difficulty: 'mudah' },
    { audioText: 'Beritahu jurulatih: latihan bola sepak ditunda ke hari Selasa.', question: 'Bila latihan ditunda?', answer: 'Hari Selasa', options: ['Hari Selasa', 'Hari Isnin', 'Hari Rabu', 'Hari Ahad'], topic: 'pesanan-permintaan', difficulty: 'mudah' },
    { audioText: 'Sampaikan kepada emak: saya dapat nombor satu dalam ujian Matematik.', question: 'Ujian apa yang disebut?', answer: 'Matematik', options: ['Matematik', 'Sains', 'Bahasa Melayu', 'Pendidikan Jasmani'], topic: 'pesanan-permintaan', difficulty: 'mudah' },
    { audioText: 'Minta tolong abang belikan tiga batang pensel di kedai.', question: 'Berapa batang pensel diminta?', answer: 'Tiga', options: ['Tiga', 'Dua', 'Lima', 'Empat'], topic: 'pesanan-permintaan', difficulty: 'mudah' },
  ],
