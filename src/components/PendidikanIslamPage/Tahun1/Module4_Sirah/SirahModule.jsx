  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .srh-grid { display: grid; grid-template-columns: 1fr; gap: 0.9rem; }
        @media (min-width: 640px) { .srh-grid { grid-template-columns: repeat(2, 1fr); gap: 1rem; } }
      `}</style>
      ...
      <div style={{ padding: '1.5rem 1.5rem 0' }}>
        ...
        <div style={{
          background: 'linear-gradient(135deg, #4C1D95 0%, #7A55E0 50%, #B79CFF 100%)',
          borderRadius: 20, padding: '1.25rem 1.5rem',
          marginTop: '2rem', marginBottom: '1.75rem',
          border: '2px solid rgba(183,156,255,0.3)',
          boxShadow: '0 12px 32px rgba(122,85,224,0.3)',
        ...
        <h2 style={{
          ...
          borderLeft: '4px solid #7A55E0', lineHeight: 1,
        }}>
