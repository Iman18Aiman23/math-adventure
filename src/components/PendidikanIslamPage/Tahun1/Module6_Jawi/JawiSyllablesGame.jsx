...
export default function JawiSyllablesGame({ onBack, onHome, language, defaultSyllables }) {
    ...
    const [gameMode, setGameMode] = useState('abcd');
    ...
    if (localGameState === 'setup') {
        return (
            <div className="game-container fade-in">
                <GameHeader onBack={onBack} onHome={onHome || onBack} title={t.syllablesTitle} language={language} />
            ...
            <div className="game-container fade-in">
                ...
                <div className="card" style={{ textAlign: 'center', padding: '2rem 1.5rem', maxWidth: '600px', margin: '1rem auto' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', justifyContent: 'center' }}>
                        ...
                        <button className="btn-secondary" onClick={onHome || onBack} style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', margin: 0, padding: '0.8rem 1.5rem', fontSize: '1.1rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden', background: 'linear-gradient(180deg, #ECFDF5 0%, #D1FAE5 40%, #F0FDFA 100%)' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '1.25rem 1rem', gap: '1.25rem' }}>
                ...
                <div className="question-card fade-in" style={{
                    ...
                    <div id="question-text" style={{ fontSize: '1.1rem', opacity: 0.8, textAlign: 'center', marginTop: '1rem' }}>
                        {t.whatSyllable}
                    </div>
                    <div className="question-text-lg" style={{ textAlign: 'center' }}>
