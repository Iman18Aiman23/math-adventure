...
export function BmSukuKataKvIcon({ size = 48 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48" fill="none">
      ...
      <circle cx="33" cy="23" r="5" fill="#ffffff"/>
      <path d="M33 18 L34.5 20 L33 21.5 L31.5 20 Z" fill="#333333"/>
      <path d="M37 22 L35.5 23.5 L36 25.5 L38 24.5 Z" fill="#333333"/>
      <path d="M29 22 L30.5 23.5 L30 25.5 L28 24.5 Z" fill="#333333"/>
      <path d="M31.5 26.5 L33 25 L34.5 26.5 L33.5 28.5 Z" fill="#333333"/>
    </svg>
  );
}
...
export function BmSukuKataKvkIcon({ size = 48 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48" fill="none">
      ...
      <circle cx="33" cy="21" r="4" fill="none" stroke="#FFC800" strokeWidth="2"/>
      <circle cx="33" cy="21" r="1.5" fill="#CE82FF"/>
      <rect x="36.5" y="20" width="8" height="2" rx="1" fill="#FFC800"/>
      <rect x="41" y="22.5" width="2" height="2" rx="0.5" fill="#FFC800"/>
      <rect x="38" y="22.5" width="2" height="1.5" rx="0.5" fill="#FFC800"/>
    </svg>
  );
}
...
export function BmPhonicsIcon({ size = 48 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48" fill="none">
      ...
      <path d="M44 32C44 33.1046 43.1046 34 42 34H33C31 34 29 36 29 38V40C29 38 31 36 33 36H42C43.1046 36 44 35.1046 44 34V32Z" fill="#C91515"/>
      <rect x="16" y="18" width="3" height="7" rx="1.5" fill="#FFC800"/>
      <rect x="29" y="18" width="3" height="7" rx="1.5" fill="#1CB0F6"/>
      <rect x="8" y="21" width="6" height="2" rx="1" fill="#C91515"/>
      <rect x="8" y="26" width="4" height="2" rx="1" fill="#C91515"/>
      <rect x="34" y="21" width="6" height="2" rx="1" fill="#C91515"/>
      <rect x="34" y="26" width="4" height="2" rx="1" fill="#C91515"/>
    </svg>
  );
}
...
export function BmObjekBiasaIcon({ size = 48 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48" fill="none">
      <circle cx="24" cy="24" r="20" fill="#58CC02"/>
      <path d="M4 26C4 37.0457 12.9543 46 24 46C35.0457 46 44 37.0457 44 26V24C44 35.0457 35.0457 44 24 44C12.9543 44 4 35.0457 4 24V26Z" fill="#388E00"/>
      <circle cx="24" cy="22" r="13" fill="#ffffff"/>
      <path d="M11 23C11 30.1797 16.8203 36 24 36C31.1797 36 37 30.1797 37 23V21C37 28.1797 31.1797 34 24 34C16.8203 34 11 28.1797 11 21V23Z" fill="#E0E0E0"/>
      <circle cx="24" cy="22" r="6" fill="#58CC02"/>
      <path d="M18 22.5C18 25.8137 20.6863 28.5 24 28.5C27.3137 28.5 30 25.8137 30 22.5V21.5C30 24.8137 27.3137 27.5 24 27.5C20.6863 27.5 18 24.8137 18 21.5V22.5Z" fill="#388E00"/>
      <circle cx="24" cy="22" r="2.5" fill="#FFC800"/>
      <line x1="33" y1="31" x2="44" y2="42" stroke="#8B5E3C" strokeWidth="3" strokeLinecap="round"/>
      <line x1="33.5" y1="31.5" x2="43.5" y2="41.5" stroke="#C49A6C" strokeWidth="1" strokeLinecap="round"/>
      <path d="M36 28L40 32L44 28L42 26L40 28L38 26Z" fill="#E0E0E0"/>
      <path d="M36 28L40 32L44 28" stroke="#B0B0B0" strokeWidth="1" fill="none"/>
      <path d="M28 26L33 21L35 23L30 28Z" fill="#A0A0A0"/>
      <path d="M28 26L33 21L31.5 25.5Z" fill="#D0D0D0"/>
      <path d="M28 26L33 21L35 23L30 28Z" stroke="#707070" strokeWidth="0.5" fill="none"/>
    </svg>
  );
}
