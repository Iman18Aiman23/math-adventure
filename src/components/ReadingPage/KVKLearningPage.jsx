              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: `0 2px 0 ${SLOT_BG[ci]}, 0 8px 0 ${SLOT_COLORS[ci]}, 0 12px 16px rgba(0,0,0,0.1)`,
                    fontFamily: 'inherit',
                  }}
                  onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = `0 12px 0 ${SLOT_COLORS[ci]}, 0 18px 24px rgba(0,0,0,0.15)`; }}
                  onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = `0 8px 0 ${SLOT_COLORS[ci]}, 0 12px 16px rgba(0,0,0,0.1)`; }}
                  onMouseDown={e => { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = `0 4px 0 ${SLOT_COLORS[ci]}, 0 6px 8px rgba(0,0,0,0.08)`; }}
                  onMouseUp={e => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = `0 12px 0 ${SLOT_COLORS[ci]}, 0 18px 24px rgba(0,0,0,0.15)`; }}
                >
