import{j as a}from"./index-YCInXYg5.js";import{B as d}from"./BMHeader-B5cOc9J_.js";function g({language:t="bm",accentColor:n="#E8821A",topicTitle:e,definition:o,examples:p=[],conclusion:r,onStart:i,onBack:x}){return a.jsxs(a.Fragment,{children:[a.jsx("style",{children:`
        .nota-root {
          height: 100dvh; overflow: hidden;
          background:
            radial-gradient(ellipse 60% 40% at 80% 8%, ${n}1f 0%, transparent 60%),
      ...
      `}),a.jsxs("div",{className:"nota-root",children:[a.jsx(d,{onBack:x,language:t,title:e,sticky:!0}),a.jsx("div",{className:"nota-body",children:a.jsxs("div",{className:"nota-card",children:[a.jsx("div",{className:"nota-tape"}),a.jsx("div",{className:"nota-rocket",children:"🚀"}),a.jsx("div",{className:"nota-fold"}),a.jsxs("span",{className:"nota-badge",children:["📝 ",t==="bm"?"Nota Penting":"Important Note"]}),a.jsx("h2",{className:"nota-title",children:e}),o&&a.jsx("p",{className:"nota-def",children:o}),p.length>0&&a.jsxs(a.Fragment,{children:[a.jsxs("div",{className:"nota-contoh-label",children:["💡 ",t==="bm"?"Contoh:":"Example:"]}),a.jsx("div",{className:"nota-contoh",children:p.map((l,s)=>a.jsx("p",{children:l},s))})]}),r&&a.jsx("div",{className:"nota-concl",children:r}),a.jsx("div",{className:"nota-cta-wrap",children:a.jsx("button",{className:"nota-cta",onClick:i,children:t==="bm"?"Mula Kuiz →":"Start Quiz →"})})]})})]})]})}export{g as B};
